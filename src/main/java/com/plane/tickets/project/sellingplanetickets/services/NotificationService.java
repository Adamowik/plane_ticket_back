...
public class NotificationService {
    ...
    public void sendNotification(User user) throws MailException {
        ...
        mail.setSubject(user.getName() + " witaj na mojej stronie!");
        mail.setText("Rejestracja przebiegła pomyślnie. Możesz teraz w pełni korzystać z mojej strony.");
        javaMailSender.send(mail);
    }

    public void sendTicket(TicketDTO ticketDTO) throws MailException, ParseException {
        ...
        stringBuilder
                ...
                .append(insurance)
                .append("Dziękujemy za skorzystanie z naszych usług. Swoje bilety możesz także zobaczyć po zalogowaniu na mojej stronie");
